阿里云DataV数字化解决方案Terraform模块

# terraform-alicloud-datav-for-digitalization

[English](https://github.com/alibabacloud-automation/terraform-alicloud-datav-for-digitalization/blob/main/README.md) | 简体中文

在阿里云上创建DataV数字化解决方案基础设施的Terraform模块。此模块实现了[快速搭建企业经营大屏](https://www.aliyun.com/solution/tech-solution/datav-for-digitalization)的解决方案，涉及专有网络（VPC）、交换机（VSwitch）、RDS数据库（RDS）等资源的部署。

## 使用方法

此模块创建DataV数字化解决方案所需的完整基础设施堆栈，包括VPC、VSwitch、安全组、RDS MySQL实例、数据库和数据库账号。所有资源都按照企业管理大屏场景的最佳实践进行配置。
...
* [完整示例](https://github.com/alibabacloud-automation/terraform-alicloud-datav-for-digitalization/tree/main/examples/complete)
